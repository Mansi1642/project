...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account ||MEDI CARE</title>
          ...
          <div class="row">
            ...
            <div class="small-8 columns end">
              ...
              echo '</div>';
			   echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Contact Number</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  echo '<input type="number" id="right-label" placeholder="'. $obj->contact_number. '" name="contact_number">';
                  echo '</div>';
                  echo '</div>';
          ?>
