...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Orders || MEDI CARE</title>
...
@media (max-width: 880px) {
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">MED CARE</a></h1>
        </li>
          ...
          if($result) {
            while($obj = $result->fetch_object()) {
              ...
              echo '<p><strong>Product Name</strong>: '.$obj->product_name.'</p>';
			   echo '<p><strong>Product Description</strong>: '.$obj->product_desc.'</p>';
              echo '<p><strong>Price Per Unit</strong>: '.$obj->price.'</p>';
              echo '<p><strong>Units Bought</strong>: '.$obj->units.'</p>';
              echo '<p><strong>Total Cost</strong>: '.$currency.$obj->total.'</p>';
			  echo '<p><strong>Order Number</strong>: '.$obj->order_number.'</p>';
			  echo '<p><strong>Email</strong>: '.$obj->email.'</p>' ;
			   echo '<p><strong>Username</strong>: '.$obj->username.'</p>';
              //echo '</div>';
              //echo '<div class="large-6">';
