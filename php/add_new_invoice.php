<?php
  ...
  if(isset($_GET['action']) && $_GET['action'] == "is_customer")
    isCustomer(strtoupper($_GET['fname']), $_GET['contact_number']);
  ...
  function isCustomer($fname, $contact_number) {
    require "db_connection.php";
    if($con) {
      $query = "SELECT * FROM customers WHERE UPPER(FNAME) = '$name' AND CONTACT_NUMBER = '$contact_number'";
